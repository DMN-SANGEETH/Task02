...
public class IssueServiceIMPL implements IssueService {
    ...
    public IssueServiceIMPL(IssueRepo issueRepo, ModelMapper modelMapper, IssueStatusRepo issueStatusRepo, IssueTypeRepo issueTypeRepo, UserRepo userRepo, AllDataHistoryRepo allDataHistoryRepo) {
...
//        issue.setIssueType(issueTypeRepo.findByIssueTypeId(issueRequestDto.getIssueTypeId()));
//        issue.setIssueStatus(issueStatusRepo.findByStatusId(issueRequestDto.getStatusId()));
//        issue.setUser(userRepo.findByUserId(issueRequestDto.getUserId()));

        IssueType issueType = issueTypeRepo.findById(issueRequestDto.getIssueTypeId()).orElse(null);
        issue.setIssueType(issueType);

        IssueStatus issueStatus = issueStatusRepo.findById(issueRequestDto.getStatusId()).orElse(null);
        issue.setIssueStatus(issueStatus);

        User user = userRepo.findById(issueRequestDto.getUserId()).orElse(null);
        issue.setUser(user);
